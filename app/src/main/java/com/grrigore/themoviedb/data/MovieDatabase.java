...
public abstract class MovieDatabase extends RoomDatabase {
    ...
    private static volatile MovieDatabase movieDatabaseInsatnce;

    public static synchronized MovieDatabase getMovieDatabaseInsatnce(Context context) {
        if (movieDatabaseInsatnce == null) {
            movieDatabaseInsatnce = create(context);
        }

        return movieDatabaseInsatnce;
    }
